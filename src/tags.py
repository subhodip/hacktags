...
lang = "english"
##Example text ends
#Parse the sentence and tokenize them
def getTags(text, lang):
    filteredSentence = []
...
#Parse tokenized words and chunk them to requirement
def chunkWords(word, filterMap):
    return None

#parse tokenized and chunked words and chink unnecessary words
def chinkWords(word):
    return None
